# Form implementation generated from reading ui file 'CribbageV1.1-Players-Activity.ui'
#
...
class Ui_Master(object):
    def setupUi(self, Master):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 20, 123, 131))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(150, 20, 141, 131))
...
"font: 700 11pt \"Segoe UI\";")
        ...
        self.playerActivityPanel = QtWidgets.QFrame(parent=self.sessionPanel)
        self.playerActivityPanel.setGeometry(QtCore.QRect(340, 20, 741, 171))
        self.playerActivityPanel.setFrameShape(QtWidgets.QFrame.Shape.Panel)
        self.playerActivityPanel.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.playerActivityPanel.setLineWidth(2)
        self.playerActivityPanel.setObjectName("playerActivityPanel")
        self.layoutWidget2 = QtWidgets.QWidget(parent=self.playerActivityPanel)
        self.layoutWidget2.setGeometry(QtCore.QRect(40, 20, 341, 141))
        ...
        self.verticalLayoutWidget = QtWidgets.QWidget(parent=self.playerActivityPanel)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(400, 20, 331, 141))
